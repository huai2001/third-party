...
//窗口资源
class SKIN_CONTROLS_CLASS CSkinDialogAttribute
{
	//颜色定义
public:
...
//分层窗口
class SKIN_CONTROLS_CLASS CSkinLayered : public CWnd
{
	//变量定义
protected:
...
//对话框类
class SKIN_CONTROLS_CLASS CSkinDialog : public CDialog
{
	//按钮状态
private:
